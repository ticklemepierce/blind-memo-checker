...
parcelRequire.register("3TT0s", function(module, exports) {

$parcel$export(module.exports, "randomFTOScrambleString", () => $2d712d421c5a0a35$export$77ea2542cbd1e7a9);
...
async function $2d712d421c5a0a35$export$77ea2542cbd1e7a9() {
    const { randomFTOScrambleString: randomFTOScrambleString2  } = await (parcelRequire("kvw4e"));
    return randomFTOScrambleString2();
}
var $2d712d421c5a0a35$var$cachedData = null;
async function $2d712d421c5a0a35$export$3db3de3f0166a282() {
    return $2d712d421c5a0a35$var$cachedData ?? ($2d712d421c5a0a35$var$cachedData = $2d712d421c5a0a35$var$uncachedSGSDataFTO());
}
async function $2d712d421c5a0a35$var$uncachedSGSDataFTO() {
    return (0, $a4PuW.parseSGS)(await (0, $lLkc4.puzzles)["fto"].kpuzzle(), `SubgroupSizes 24 12 11 12 12 11 10 9 11 8 10 9 7 8 10 10 6 9 8 5 7 6 5 4 4 8 7 3 6 6 360
...
parcelRequire.register("kvw4e", function(module, exports) {

module.exports = import("./" + (parcelRequire("aKzDW")).resolve("2Mivu")).then(()=>parcelRequire("kxMDO"));

});



//# sourceMappingURL=fto.dynamic-3MSUIE4Q.36ca5a9f.js.map

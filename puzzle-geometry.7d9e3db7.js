...
parcelRequire.register("lYeJM", function(module, exports) {

$parcel$export(module.exports, "parseOptions", () => $ffeaa21825838879$export$49fe41a914eb071d);
$parcel$export(module.exports, "parsePuzzleDescription", () => $ffeaa21825838879$export$f4bd658db3408711);
$parcel$export(module.exports, "Quat", () => $ffeaa21825838879$export$5edfe12bb88684c8);
$parcel$export(module.exports, "schreierSims", () => $ffeaa21825838879$export$f17eb225ad7d7738);
$parcel$export(module.exports, "getPG3DNamedPuzzles", () => $ffeaa21825838879$export$6d6c096d5214295b);
$parcel$export(module.exports, "getPuzzleDescriptionString", () => $ffeaa21825838879$export$1f9f297c0a9a9cd1);
$parcel$export(module.exports, "getPuzzleGeometryByDesc", () => $ffeaa21825838879$export$898ad9435742d552);
$parcel$export(module.exports, "PuzzleGeometry", () => $ffeaa21825838879$export$b89c271f50b83709);
$parcel$export(module.exports, "getPuzzleGeometryByName", () => $ffeaa21825838879$export$37497081d872df9);
$parcel$export(module.exports, "PGNotation", () => $ffeaa21825838879$export$32c5b60afe204e84);

var $7TbMZ = parcelRequire("7TbMZ");
// src/cubing/puzzle-geometry/FaceNameSwizzler.ts
var $ffeaa21825838879$var$FaceNameSwizzler = class {
...
var $ffeaa21825838879$var$NullMapper = class {
...
var $ffeaa21825838879$var$FTONotationMapper = class {
    constructor(child, sw){
        this.child = child;
        this.sw = sw;
    }
    notationToInternal(move) {
        if (move.family === "T" && move.innerLayer === void 0 && move.outerLayer === void 0) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("FLRv", move.innerLayer, move.outerLayer), move.amount);
        else {
    ...
    notationToExternal(move) {
        ...
        if (this.sw.spinmatch(fam, "FLUR")) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("T", move.innerLayer, move.outerLayer), move.amount);
        return this.child.notationToExternal(move);
    }
};
// src/cubing/puzzle-geometry/notation-mapping/FaceRenamingMapper.ts
var $ffeaa21825838879$var$FaceRenamingMapper = class {
    ...
    convert(move, a, b) {
        ...
        else return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(ngrip, move.innerLayer, move.outerLayer), move.amount);
    }
    notationToInternal(move) {
...
var $ffeaa21825838879$var$MegaminxScramblingNotationMapper = class {
    constructor(child){
        this.child = child;
    }
    notationToInternal(move) {
        if (move.innerLayer === void 0 && move.outerLayer === void 0) {
            if (Math.abs(move.amount) === 1) {
                if (move.family === "R++") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("L", 3, 2), -2 * move.amount);
                else if (move.family === "R--") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("L", 3, 2), 2 * move.amount);
                else if (move.family === "D++") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("U", 3, 2), -2 * move.amount);
                else if (move.family === "D--") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("U", 3, 2), 2 * move.amount);
                if (move.family === "R_PLUSPLUS_") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("L", 3, 2), -2 * move.amount);
                else if (move.family === "D_PLUSPLUS_") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("U", 3, 2), -2 * move.amount);
            }
            if (move.family === "y") return new (0, $7TbMZ.Move)("Uv", move.amount);
        }
        return this.child.notationToInternal(move);
    }
    notationToExternal(move) {
        if (move.family === "Uv") return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("y", move.innerLayer, move.outerLayer), move.amount);
        if (move.family === "Dv") return new (0, $7TbMZ.Move)("y", -move.amount);
        return this.child.notationToExternal(move);
    }
};
// src/cubing/puzzle-geometry/notation-mapping/NxNxNCubeMapper.ts
var $ffeaa21825838879$var$NxNxNCubeMapper = class {
    constructor(slices){
        this.slices = slices;
    }
    notationToInternal(move) {
        ...
        if (!move.innerLayer && !move.outerLayer) {
            if (grip === "x") move = new (0, $7TbMZ.Move)("Rv", move.amount);
            else if (grip === "y") move = new (0, $7TbMZ.Move)("Uv", move.amount);
            else if (grip === "z") move = new (0, $7TbMZ.Move)("Fv", move.amount);
            if ((this.slices & 1) === 1) {
                if (grip === "E") move = new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("D", (this.slices + 1) / 2), move.amount);
                else if (grip === "M") move = new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("L", (this.slices + 1) / 2), move.amount);
                else if (grip === "S") move = new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("F", (this.slices + 1) / 2), move.amount);
            }
            if (this.slices > 2) {
                if (grip === "e") move = new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("D", this.slices - 1, 2), move.amount);
                else if (grip === "m") move = new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)("L", this.slices - 1, 2), move.amount);
    ...
    notationToExternal(move) {
        const grip = move.family;
        if (!move.innerLayer && !move.outerLayer) {
            if (grip === "Rv") return new (0, $7TbMZ.Move)("x", move.amount);
            else if (grip === "Uv") return new (0, $7TbMZ.Move)("y", move.amount);
            else if (grip === "Fv") return new (0, $7TbMZ.Move)("z", move.amount);
            else if (grip === "Lv") return new (0, $7TbMZ.Move)("x", -move.amount);
            else if (grip === "Dv") return new (0, $7TbMZ.Move)("y", -move.amount);
            else if (grip === "Bv") return new (0, $7TbMZ.Move)("z", -move.amount);
        }
        return move;
    }
};
// src/cubing/puzzle-geometry/notation-mapping/PyraminxNotationMapper.ts
var $ffeaa21825838879$var$pyraminxFamilyMap = {
    U: "frl",
    L: "fld",
    R: "fdr",
    B: "dlr",
...
var $ffeaa21825838879$var$tetraminxFamilyMap = {
    U: "FRL",
    L: "FLD",
    R: "FDR",
    B: "DLR",
...
var $ffeaa21825838879$var$pyraminxFamilyMapWCA = {
    U: "FRL",
    L: "FLD",
    R: "FDR",
    B: "DLR"
};
var $ffeaa21825838879$var$pyraminxExternalQuantumY = new (0, $7TbMZ.QuantumMove)("y");
var $ffeaa21825838879$var$pyraminxInternalQuantumY = new (0, $7TbMZ.QuantumMove)("Dv");
var $ffeaa21825838879$var$PyraminxNotationMapper = class {
    constructor(child){
        this.child = child;
        this.wcaHack = false;
        this.map = $ffeaa21825838879$var$pyraminxFamilyMap;
    }
    notationToInternal(move) {
        if (this.wcaHack && move.innerLayer === 2 && move.outerLayer === null) {
            const newFamilyWCA = $ffeaa21825838879$var$pyraminxFamilyMapWCA[move.family];
            if (newFamilyWCA) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(newFamilyWCA, move.innerLayer, move.outerLayer), move.amount);
        }
        const newFamily = this.map[move.family];
        if (newFamily) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(newFamily, move.innerLayer, move.outerLayer), move.amount);
        else if ($ffeaa21825838879$var$pyraminxExternalQuantumY.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$pyraminxInternalQuantumY, -move.amount);
        else return null;
    }
    notationToExternal(move) {
        if (this.wcaHack && move.innerLayer === 2 && move.outerLayer === null) for (const [external, internal] of Object.entries($ffeaa21825838879$var$pyraminxFamilyMapWCA)){
            if (this.child.spinmatch(move.family, internal)) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(external, move.innerLayer, move.outerLayer), move.amount);
        }
        for (const [external1, internal1] of Object.entries(this.map)){
            if (this.child.spinmatch(move.family, internal1)) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(external1, move.innerLayer, move.outerLayer), move.amount);
        }
        if ($ffeaa21825838879$var$pyraminxInternalQuantumY.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$pyraminxExternalQuantumY, -move.amount);
        else return null;
    }
};
var $ffeaa21825838879$var$TetraminxNotationMapper = class extends $ffeaa21825838879$var$PyraminxNotationMapper {
    constructor(child){
        super(child);
        this.map = $ffeaa21825838879$var$tetraminxFamilyMap;
    }
};
// src/cubing/puzzle-geometry/notation-mapping/SkewbNotationMapper.ts
var $ffeaa21825838879$var$skewbFamilyMap = {
    U: "UBL",
    UL: "ULF",
    F: "UFR",
    UR: "URB",
...
var $ffeaa21825838879$var$skewbExternalQuantumX = new (0, $7TbMZ.QuantumMove)("x");
var $ffeaa21825838879$var$skewbInternalQuantumX = new (0, $7TbMZ.QuantumMove)("Rv");
var $ffeaa21825838879$var$skewbInternalQuantumXPrime = new (0, $7TbMZ.QuantumMove)("Lv");
var $ffeaa21825838879$var$skewbExternalQuantumY = new (0, $7TbMZ.QuantumMove)("y");
var $ffeaa21825838879$var$skewbInternalQuantumY = new (0, $7TbMZ.QuantumMove)("Uv");
var $ffeaa21825838879$var$skewbInternalQuantumYPrime = new (0, $7TbMZ.QuantumMove)("Dv");
var $ffeaa21825838879$var$skewbExternalQuantumZ = new (0, $7TbMZ.QuantumMove)("z");
var $ffeaa21825838879$var$skewbInternalQuantumZ = new (0, $7TbMZ.QuantumMove)("Fv");
var $ffeaa21825838879$var$skewbInternalQuantumZPrime = new (0, $7TbMZ.QuantumMove)("Bv");
var $ffeaa21825838879$var$SkewbNotationMapper = class {
    constructor(child){
        this.child = child;
    }
    notationToInternal(move) {
        if (move.innerLayer || move.outerLayer) return null;
        const newFamily = $ffeaa21825838879$var$skewbFamilyMap[move.family];
        if (newFamily) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(newFamily, move.outerLayer, move.innerLayer), move.amount);
        if ($ffeaa21825838879$var$skewbExternalQuantumX.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbInternalQuantumX, move.amount);
        if ($ffeaa21825838879$var$skewbExternalQuantumY.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbInternalQuantumY, move.amount);
        if ($ffeaa21825838879$var$skewbExternalQuantumZ.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbInternalQuantumZ, move.amount);
        return null;
    }
    notationToExternal(move) {
        for (const [external, internal] of Object.entries($ffeaa21825838879$var$skewbFamilyMap)){
            if (this.child.spinmatchv(move.family, internal)) return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(external, move.innerLayer, move.outerLayer), move.amount);
        }
        if ($ffeaa21825838879$var$skewbInternalQuantumX.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumX, move.amount);
        if ($ffeaa21825838879$var$skewbInternalQuantumXPrime.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumX, -move.amount);
        if ($ffeaa21825838879$var$skewbInternalQuantumY.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumY, move.amount);
        if ($ffeaa21825838879$var$skewbInternalQuantumYPrime.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumY, -move.amount);
        if ($ffeaa21825838879$var$skewbInternalQuantumZ.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumZ, move.amount);
        if ($ffeaa21825838879$var$skewbInternalQuantumZPrime.isIdentical(move.quantum)) return new (0, $7TbMZ.Move)($ffeaa21825838879$var$skewbExternalQuantumZ, -move.amount);
        return null;
    }
};
// src/cubing/puzzle-geometry/Options.ts
function $ffeaa21825838879$export$49fe41a914eb071d(argv) {
    let argp = 0;
    const options = {};
    ...
    const puzzleDescription = $ffeaa21825838879$export$f4bd658db3408711(argv.slice(argp).join(" "));
    return {
        puzzleDescription: puzzleDescription,
        options: options
    };
}
var $ffeaa21825838879$var$PuzzleGeometryFullOptions = class {
    constructor(options = {}){
        this.verbosity = 0;
        this.allMoves = false;
...
var $ffeaa21825838879$var$zeroCache = [];
var $ffeaa21825838879$var$iotaCache = [];
function $ffeaa21825838879$var$zeros(n) {
    if (!$ffeaa21825838879$var$zeroCache[n]) {
        const c = Array(n);
        for(let i = 0; i < n; i++)c[i] = 0;
        $ffeaa21825838879$var$zeroCache[n] = c;
    }
    return $ffeaa21825838879$var$zeroCache[n];
}
function $ffeaa21825838879$var$iota(n) {
    if (!$ffeaa21825838879$var$iotaCache[n]) {
        const c = Array(n);
        for(let i = 0; i < n; i++)c[i] = i;
        $ffeaa21825838879$var$iotaCache[n] = c;
    }
    return $ffeaa21825838879$var$iotaCache[n];
}
function $ffeaa21825838879$var$identity(n) {
    return new $ffeaa21825838879$var$Perm($ffeaa21825838879$var$iota(n));
}
function $ffeaa21825838879$var$factorial(a) {
    let r = 1;
    while(a > 1){
        r *= a;
        a--;
...
function $ffeaa21825838879$var$gcd(a, b) {
    if (a > b) {
        const t = a;
        a = b;
        b = t;
...
function $ffeaa21825838879$var$lcm(a, b) {
    return a / $ffeaa21825838879$var$gcd(a, b) * b;
}
var $ffeaa21825838879$var$Perm = class {
    constructor(a){
        this.n = a.length;
        this.p = a;
    }
    ...
    mul(p2) {
        ...
        return new $ffeaa21825838879$var$Perm(c);
    }
    rmul(p2) {
        const c = Array(this.n);
    ...
    order() {
        ...
        for(let i = 0; i < this.p.length; i++){
            ...
            r = $ffeaa21825838879$var$lcm(r, cs);
        }
        return r;
    }
};
// src/cubing/puzzle-geometry/PermOriSet.ts
var $ffeaa21825838879$var$PGOrbitDef = class {
    constructor(size, mod){
        this.size = size;
        this.mod = mod;
    }
    reassemblySize() {
        return $ffeaa21825838879$var$factorial(this.size) * Math.pow(this.mod, this.size);
    }
};
var $ffeaa21825838879$var$lastGlobalDefinitionCounter = 0;
function $ffeaa21825838879$var$externalName(mapper, moveString) {
    const mv = (0, $7TbMZ.Move).fromString(moveString);
    const mv2 = mapper.notationToExternal(mv);
    if (mv2 === null || mv === mv2) return moveString;
    return mv2.toString();
}
var $ffeaa21825838879$var$PGOrbitsDef = class {
    ...
    toKsolve(name, mapper = new $ffeaa21825838879$var$NullMapper()) {
        const result = [];
        ...
        for(let i2 = 0; i2 < this.movenames.length; i2++){
            result.push("");
            let name2 = $ffeaa21825838879$var$externalName(mapper, this.movenames[i2]);
            let doinv = false;
    ...
    toKPuzzleDefinition(includemoves) {
        ...
        return {
            name: `PG3D #${++$ffeaa21825838879$var$lastGlobalDefinitionCounter}`,
            orbits: orbits,
    ...
    optimize() {
        ...
        for(let i = 0; i < this.orbitdefs.length; i++){
            ...
            const du = new $ffeaa21825838879$var$DisjointUnion(n);
            ...
            if (om > 1) {
                keepori = false;
                const duo = new $ffeaa21825838879$var$DisjointUnion(this.orbitdefs[i].size * om);
            ...
            for(let j3 = 0; j3 < this.orbitdefs[i].size; j3++){
                ...
                if (keepori) {
                    neworbitdefs.push(new $ffeaa21825838879$var$PGOrbitDef(nv, this.orbitdefs[i].mod));
                    ...
                    neworbitdefs.push(new $ffeaa21825838879$var$PGOrbitDef(nv, 1));
        ...
        return new $ffeaa21825838879$var$PGOrbitsDef(neworbitnames, neworbitdefs, new $ffeaa21825838879$var$VisibleState(newsolved), this.movenames, newmoveops.map((_)=>new $ffeaa21825838879$var$PGTransform(_)));
    }
    scramble(n) {
...
var $ffeaa21825838879$var$_PGOrbit = class {
    ...
    static e(n, mod) {
        return new $ffeaa21825838879$var$_PGOrbit($ffeaa21825838879$var$iota(n), $ffeaa21825838879$var$zeros(n), mod);
    }
    mul(b) {
        ...
        if (this.orimod === 1) {
            ...
            return new $ffeaa21825838879$var$_PGOrbit(newPerm, this.ori, this.orimod);
        } else {
            ...
            return new $ffeaa21825838879$var$_PGOrbit(newPerm, newOri, this.orimod);
        }
    }
    inv() {
        const n = this.perm.length;
    ...
    isIdentity() {
        const n = this.perm.length;
        if (this.perm === $ffeaa21825838879$var$iota(n) && this.ori === $ffeaa21825838879$var$zeros(n)) return true;
        for(let i = 0; i < n; i++){
    ...
    zeroOris() {
        const n = this.perm.length;
        if (this.ori === $ffeaa21825838879$var$zeros(n)) return true;
        for(let i = 0; i < n; i++){
    ...
    toKPuzzle() {
        const n = this.perm.length;
        if (this.isIdentity()) {
            if (!$ffeaa21825838879$var$_PGOrbit.kcache[n]) $ffeaa21825838879$var$_PGOrbit.kcache[n] = {
                permutation: $ffeaa21825838879$var$iota(n),
                orientation: $ffeaa21825838879$var$zeros(n)
            };
            return $ffeaa21825838879$var$_PGOrbit.kcache[n];
        } else return {
...
var $ffeaa21825838879$var$PGOrbit = $ffeaa21825838879$var$_PGOrbit;
$ffeaa21825838879$var$PGOrbit.kcache = [];
var $ffeaa21825838879$var$PGTransformBase = class {
    constructor(orbits){
        this.orbits = orbits;
    }
    internalMul(b) {
    ...
    order() {
        let r = 1;
        for (const orbit of this.orbits)r = $ffeaa21825838879$var$lcm(r, orbit.order());
        return r;
    }
};
var $ffeaa21825838879$var$PGTransform = class extends $ffeaa21825838879$var$PGTransformBase {
    constructor(orbits){
        super(orbits);
    }
    mul(b) {
        return new $ffeaa21825838879$var$PGTransform(this.internalMul(b));
    }
    mulScalar(n) {
    ...
    inv() {
        return new $ffeaa21825838879$var$PGTransform(this.internalInv());
    }
    e() {
        return new $ffeaa21825838879$var$PGTransform(this.orbits.map((_)=>$ffeaa21825838879$var$PGOrbit.e(_.perm.length, _.orimod)));
    }
};
var $ffeaa21825838879$var$VisibleState = class extends $ffeaa21825838879$var$PGTransformBase {
    constructor(orbits){
        super(orbits);
    }
    mul(b) {
        return new $ffeaa21825838879$var$VisibleState(this.internalMul(b));
    }
};
var $ffeaa21825838879$var$DisjointUnion = class {
    constructor(n){
        this.n = n;
...
function $ffeaa21825838879$var$showcanon(g, disp) {
...
var $ffeaa21825838879$var$PGPuzzles = {
    "2x2x2": "c f 0",
...
var $ffeaa21825838879$var$eps = 1e-9;
function $ffeaa21825838879$var$centermassface(face) {
    let s = new $ffeaa21825838879$export$5edfe12bb88684c8(0, 0, 0, 0);
    for(let i = 0; i < face.length; i++)s = s.sum(face[i]);
    return s.smul(1 / face.length);
}
function $ffeaa21825838879$var$solvethreeplanes(p1, p2, p3, planes) {
...
var $ffeaa21825838879$export$5edfe12bb88684c8 = class {
    constructor(a, b, c, d){
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    mul(q) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a * q.a - this.b * q.b - this.c * q.c - this.d * q.d, this.a * q.b + this.b * q.a + this.c * q.d - this.d * q.c, this.a * q.c - this.b * q.d + this.c * q.a + this.d * q.b, this.a * q.d + this.b * q.c - this.c * q.b + this.d * q.a);
    }
    toString() {
    ...
    cross(q) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(0, this.c * q.d - this.d * q.c, this.d * q.b - this.b * q.d, this.b * q.c - this.c * q.b);
    }
    dot(q) {
    ...
    normalize() {
        ...
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a / d, this.b / d, this.c / d, this.d / d);
    }
    makenormal() {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(0, this.b, this.c, this.d).normalize();
    }
    normalizeplane() {
    ...
    smul(m) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a * m, this.b * m, this.c * m, this.d * m);
    }
    sum(q) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a + q.a, this.b + q.b, this.c + q.c, this.d + q.d);
    }
    sub(q) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a - q.a, this.b - q.b, this.c - q.c, this.d - q.d);
    }
    ...
    invrot() {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(this.a, -this.b, -this.c, -this.d);
    }
    det3x3(a00, a01, a02, a10, a11, a12, a20, a21, a22) {
        return a00 * (a11 * a22 - a12 * a21) + a01 * (a12 * a20 - a10 * a22) + a02 * (a10 * a21 - a11 * a20);
    }
    rotateplane(q) {
        const t = q.mul(new $ffeaa21825838879$export$5edfe12bb88684c8(0, this.b, this.c, this.d)).mul(q.invrot());
        t.a = this.a;
        return t;
    }
    orthogonal() {
        ...
        if (ab < ac && ab < ad) return this.cross(new $ffeaa21825838879$export$5edfe12bb88684c8(0, 1, 0, 0)).normalize();
        else if (ac < ab && ac < ad) return this.cross(new $ffeaa21825838879$export$5edfe12bb88684c8(0, 0, 1, 0)).normalize();
        else return this.cross(new $ffeaa21825838879$export$5edfe12bb88684c8(0, 0, 0, 1)).normalize();
    }
    pointrotation(b) {
        const a = this.normalize();
        b = b.normalize();
        if (a.sub(b).len() < $ffeaa21825838879$var$eps) return new $ffeaa21825838879$export$5edfe12bb88684c8(1, 0, 0, 0);
        let h = a.sum(b);
        if (h.len() < $ffeaa21825838879$var$eps) h = h.orthogonal();
        else h = h.normalize();
        const r = a.cross(h);
        r.a = a.dot(h);
        return r;
    ...
    intersect3(p2, p3) {
        ...
        if (Math.abs(det) < $ffeaa21825838879$var$eps) return false;
        return new $ffeaa21825838879$export$5edfe12bb88684c8(0, this.det3x3(this.a, this.c, this.d, p2.a, p2.c, p2.d, p3.a, p3.c, p3.d) / det, this.det3x3(this.b, this.a, this.d, p2.b, p2.a, p2.d, p3.b, p3.a, p3.d) / det, this.det3x3(this.b, this.c, this.a, p2.b, p2.c, p2.a, p3.b, p3.c, p3.a) / det);
    }
    side(x) {
        if (x > $ffeaa21825838879$var$eps) return 1;
        if (x < -$ffeaa21825838879$var$eps) return -1;
        return 0;
    }
    cutface(face) {
    ...
    sameplane(p) {
        const a = this.normalize();
        const b = p.normalize();
        return a.dist(b) < $ffeaa21825838879$var$eps || a.dist(b.smul(-1)) < $ffeaa21825838879$var$eps;
    }
    makecut(r) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(r, this.b, this.c, this.d);
    }
};
// src/cubing/puzzle-geometry/PlatonicGenerator.ts
var $ffeaa21825838879$var$eps2 = 1e-9;
function $ffeaa21825838879$var$cube() {
    const s5 = Math.sqrt(0.5);
    return [
        new $ffeaa21825838879$export$5edfe12bb88684c8(s5, s5, 0, 0),
        new $ffeaa21825838879$export$5edfe12bb88684c8(s5, 0, s5, 0)
    ];
}
function $ffeaa21825838879$var$tetrahedron() {
    return [
        new $ffeaa21825838879$export$5edfe12bb88684c8(0.5, 0.5, 0.5, 0.5),
        new $ffeaa21825838879$export$5edfe12bb88684c8(0.5, 0.5, 0.5, -0.5)
    ];
}
function $ffeaa21825838879$var$dodecahedron() {
    ...
    dy /= dd;
    return [
        new $ffeaa21825838879$export$5edfe12bb88684c8(Math.cos(d36), dx * Math.sin(d36), dy * Math.sin(d36), 0),
        new $ffeaa21825838879$export$5edfe12bb88684c8(0.5, 0.5, 0.5, 0.5)
    ];
}
function $ffeaa21825838879$var$icosahedron() {
    ...
    return [
        new $ffeaa21825838879$export$5edfe12bb88684c8(Math.cos(ang), dx * Math.sin(ang), dy * Math.sin(ang), 0),
        new $ffeaa21825838879$export$5edfe12bb88684c8(Math.cos(ang), -dx * Math.sin(ang), dy * Math.sin(ang), 0)
    ];
}
function $ffeaa21825838879$var$octahedron() {
    const s5 = Math.sqrt(0.5);
    return [
        new $ffeaa21825838879$export$5edfe12bb88684c8(0.5, 0.5, 0.5, 0.5),
        new $ffeaa21825838879$export$5edfe12bb88684c8(s5, 0, 0, s5)
    ];
}
function $ffeaa21825838879$var$closure(g) {
    const q = [
        new $ffeaa21825838879$export$5edfe12bb88684c8(1, 0, 0, 0)
    ];
    for(let i = 0; i < q.length; i++)for(let j = 0; j < g.length; j++){
        const ns = g[j].mul(q[i]);
        const negns = ns.smul(-1);
        let wasseen = false;
        for(let k = 0; k < q.length; k++)if (ns.dist(q[k]) < $ffeaa21825838879$var$eps2 || negns.dist(q[k]) < $ffeaa21825838879$var$eps2) {
            wasseen = true;
            break;
        }
...
function $ffeaa21825838879$var$uniqueplanes(p, g) {
    const planes = [];
    const planerot = [];
    for(let i = 0; i < g.length; i++){
        const p2 = p.rotateplane(g[i]);
        let wasseen = false;
        for(let j = 0; j < planes.length; j++)if (p2.dist(planes[j]) < $ffeaa21825838879$var$eps2) {
            wasseen = true;
            break;
        }
        if (!wasseen) {
...
function $ffeaa21825838879$var$getface(planes) {
    const face = [];
    for(let i = 1; i < planes.length; i++)for(let j = i + 1; j < planes.length; j++){
        const p = $ffeaa21825838879$var$solvethreeplanes(0, i, j, planes);
        if (p) {
            let wasseen = false;
            for(let k = 0; k < face.length; k++)if (p.dist(face[k]) < $ffeaa21825838879$var$eps2) {
                wasseen = true;
                break;
            }
...
var $ffeaa21825838879$var$FactoredNumber = class {
    constructor(){
        this.mult = [];
    }
    multiply(n) {
...
function $ffeaa21825838879$export$f17eb225ad7d7738(g, disp) {
    const n = g[0].p.length;
    const e = $ffeaa21825838879$var$identity(n);
    let sgs = [];
    let sgsi = [];
    let sgslen = [];
    let Tk = [];
    ...
    function getsgs() {
        ...
        for(let i7 = 0; i7 < g.length; i7++){
            ...
            let sollen = 0;
            const avgs = [];
            const mults = new $ffeaa21825838879$var$FactoredNumber();
            for(let j = 0; j < n; j++){
                let cnt = 0;
                let lensum = 0;
...
function $ffeaa21825838879$var$tstart(s) {
    return s;
}
function $ffeaa21825838879$var$tend(_) {}
var $ffeaa21825838879$var$Face = class {
    constructor(q){
    ...
    get(off) {
        return new $ffeaa21825838879$export$5edfe12bb88684c8(0, this.coords[3 * off], this.coords[3 * off + 1], this.coords[3 * off + 2]);
    }
    centermass() {
        let sx = 0;
        let sy = 0;
        ...
        return new $ffeaa21825838879$export$5edfe12bb88684c8(0, sx / this.length, sy / this.length, sz / this.length);
    }
    rotate(q) {
        const a = [];
        for(let i = 0; i < this.length; i++)a.push(this.get(i).rotatepoint(q));
        return new $ffeaa21825838879$var$Face(a);
    }
    rotateforward() {
        const a = [];
...
var $ffeaa21825838879$var$FaceTree = class {
    ...
    split(q) {
        ...
        if (t !== null) {
            if (this.left === void 0) {
                this.left = new $ffeaa21825838879$var$FaceTree(t[0]);
                this.right = new $ffeaa21825838879$var$FaceTree(t[1]);
            } else {
    ...
    collect(arr, leftfirst) {
        if (this.left === void 0) arr.push(new $ffeaa21825838879$var$Face(this.face));
        else if (leftfirst) {
...
function $ffeaa21825838879$var$expandfaces(rots, faces) {
    const nfaces = [];
    for (const rot of rots)for (const face of faces)nfaces.push(face.rotate(rot));
    return nfaces;
}
var $ffeaa21825838879$var$eps3 = 1e-9;
var $ffeaa21825838879$var$copyright = "PuzzleGeometry 0.1 Copyright 2018 Tomas Rokicki.";
var $ffeaa21825838879$var$permissivieMoveParsing = false;
function $ffeaa21825838879$var$defaultnets() {
    return {
        4: [
            [
                "F",
...
function $ffeaa21825838879$var$defaultcolors() {
    return {
        4: {
            F: "#00ff00",
            D: "#ffff00",
...
function $ffeaa21825838879$var$defaultfaceorders() {
    return {
        4: [
            "F",
            "D",
...
function $ffeaa21825838879$var$defaultOrientations() {
    return {
        4: [
            [
                "FLR",
...
function $ffeaa21825838879$var$findelement(a, p) {
    for(let i = 0; i < a.length; i++){
        if (a[i][0].dist(p) < $ffeaa21825838879$var$eps3) return i;
    }
    throw new Error("Element not found");
}
function $ffeaa21825838879$export$6d6c096d5214295b() {
    return $ffeaa21825838879$var$PGPuzzles;
}
function $ffeaa21825838879$export$1f9f297c0a9a9cd1(puzzleName) {
    return $ffeaa21825838879$var$PGPuzzles[puzzleName];
}
function $ffeaa21825838879$export$f4bd658db3408711(s) {
...
function $ffeaa21825838879$export$898ad9435742d552(desc, options = {}) {
    const parsed = $ffeaa21825838879$export$f4bd658db3408711(desc);
    if (parsed === null) throw new Error("Could not parse the puzzle description");
    const pg = new $ffeaa21825838879$export$b89c271f50b83709(parsed, Object.assign({}, {
        allMoves: true
    }, options));
    pg.allstickers();
    pg.genperms();
...
function $ffeaa21825838879$export$37497081d872df9(puzzleName, options) {
    return $ffeaa21825838879$export$898ad9435742d552($ffeaa21825838879$var$PGPuzzles[puzzleName], options);
}
function $ffeaa21825838879$var$getmovename(geo, bits, slices) {
    let inverted = false;
...
function $ffeaa21825838879$var$splitByFaceNames(s, facenames) {
    const r = [];
    let at = 0;
    while(at < s.length){
        if (at > 0 && at < s.length && s[at] === "_") at++;
...
function $ffeaa21825838879$var$toCoords(q, maxdist) {
    return [
        q.b / maxdist,
        -q.c / maxdist,
        q.d / maxdist
...
function $ffeaa21825838879$var$toFaceCoords(q, maxdist) {
    const r = [];
    const n = q.length;
    for(let i = 0; i < n; i++){
        const pt = $ffeaa21825838879$var$toCoords(q.get(n - i - 1), maxdist);
        r[3 * i] = pt[0];
        r[3 * i + 1] = pt[1];
        r[3 * i + 2] = pt[2];
    }
...
var $ffeaa21825838879$export$b89c271f50b83709 = class {
    constructor(puzzleDescription, options){
        ...
        this.faceorder = [];
        this.faceprecedence = [];
        this.notationMapper = new $ffeaa21825838879$var$NullMapper();
        this.addNotationMapper = "";
        this.setReidOrder = false;
        const t1 = $ffeaa21825838879$var$tstart("genperms");
        this.options = new $ffeaa21825838879$var$PuzzleGeometryFullOptions(options);
        if (this.options.verbosity > 0) console.log(this.header("# "));
        this.create(puzzleDescription);
        $ffeaa21825838879$var$tend(t1);
    }
    create(puzzleDescription) {
        ...
        switch(shape){
            case "c":
                g = $ffeaa21825838879$var$cube();
                break;
            case "o":
                g = $ffeaa21825838879$var$octahedron();
                break;
            case "i":
                g = $ffeaa21825838879$var$icosahedron();
                break;
            case "t":
                g = $ffeaa21825838879$var$tetrahedron();
                break;
            case "d":
                g = $ffeaa21825838879$var$dodecahedron();
                break;
            default:
                throw new Error("Bad shape argument: " + shape);
        }
        this.rotations = $ffeaa21825838879$var$closure(g);
        if (this.options.verbosity) console.log("# Rotations: " + this.rotations.length);
        const baseplane = g[0];
        this.baseplanerot = $ffeaa21825838879$var$uniqueplanes(baseplane, this.rotations);
        const baseplanes = this.baseplanerot.map((_)=>baseplane.rotateplane(_));
        this.baseplanes = baseplanes;
        this.baseFaceCount = baseplanes.length;
        const net = $ffeaa21825838879$var$defaultnets()[baseplanes.length];
        this.net = net;
        this.colors = $ffeaa21825838879$var$defaultcolors()[baseplanes.length];
        this.faceorder = $ffeaa21825838879$var$defaultfaceorders()[baseplanes.length];
        if (this.options.verbosity > 0) console.log("# Base planes: " + baseplanes.length);
        const baseface = $ffeaa21825838879$var$getface(baseplanes);
        const zero = new $ffeaa21825838879$export$5edfe12bb88684c8(0, 0, 0, 0);
        if (this.options.verbosity > 0) console.log("# Face vertices: " + baseface.length);
        const facenormal = baseplanes[0].makenormal();
        const edgenormal = baseface[0].sum(baseface[1]).makenormal();
        const vertexnormal = baseface[0].makenormal();
        const boundary = new $ffeaa21825838879$export$5edfe12bb88684c8(1, facenormal.b, facenormal.c, facenormal.d);
        if (this.options.verbosity > 0) console.log("# Boundary is " + boundary);
        const planerot = $ffeaa21825838879$var$uniqueplanes(boundary, this.rotations);
        const planes = planerot.map((_)=>boundary.rotateplane(_));
        const firstface = $ffeaa21825838879$var$getface(planes);
        ...
        for (const baseplanerot of this.baseplanerot){
            ...
            this.basefaces.push(new $ffeaa21825838879$var$Face(face));
        }
        const facenames = [];
        const faceplanes = [];
        const vertexnames = [];
        ...
        function searchaddelement(a, p, name) {
            for (const el of a)if (el[0].dist(p) < $ffeaa21825838879$var$eps3) {
                el.push(name);
                return;
            }
            a.push([
        ...
        for(let i8 = 0; i8 < this.baseplanerot.length; i8++){
            ...
            for(let j = 0; j < face.length; j++){
                const jj = (j + 1) % face.length;
                const midpoint = face[j].sum(face[jj]).smul(0.5);
                const el = edgenames[$ffeaa21825838879$var$findelement(edgenames, midpoint)];
        ...
        for(let i11 = 0; i11 < this.baseplanerot.length; i11++){
            ...
            for(let j = 0; j < face.length; j++){
                ...
                const e1 = $ffeaa21825838879$var$findelement(edgenames, midpoint);
                const e2 = $ffeaa21825838879$var$findelement(edgenames, midpoint2);
        ...
        this.swizzler = new $ffeaa21825838879$var$FaceNameSwizzler(facenames.map((_)=>_[1]));
        ...
        let ft = new $ffeaa21825838879$var$FaceTree(firstface);
        ...
        const simplerot = [];
        const cm = $ffeaa21825838879$var$centermassface(firstface);
        for (const rotation1 of this.rotations){
            const f = rotation1.rotateface(firstface);
            if (cm.dist($ffeaa21825838879$var$centermassface(f)) < $ffeaa21825838879$var$eps3) simplerot.push(rotation1);
        }
            ...
            if (!finished[i]) {
                ...
                for (const rot of simplerot){
                    ...
                    for(let kk = ii + 1; kk < faces.length; kk++){
                        if (sortme[kk][0] - sortme[ii][0] > $ffeaa21825838879$var$eps3) break;
                        const k = sortme[kk][2];
                        if (!finished[k] && cm2.dist(sortme[kk][1]) < $ffeaa21825838879$var$eps3) {
                            finished[k] = true;
                            faces[k] = f2;
                            break;
                        }
        ...
        if (shape === "o" && sawface) {
            this.notationMapper = new $ffeaa21825838879$var$FaceRenamingMapper(this.swizzler, new $ffeaa21825838879$var$FaceNameSwizzler([
                "F",
                "D",
                "L",
                "BL",
    ...
    findface(cm) {
        ...
        for(let i = 0; i + 1 < arr.length; i++){
            ...
            if (Math.abs(cm.dist(this.facecentermass[face2])) < $ffeaa21825838879$var$eps3) return face2;
        }
    ...
    project2d(facen, edgen, targvec) {
        ...
        const off = new $ffeaa21825838879$export$5edfe12bb88684c8(0, targvec[0].b - x1.dot(face[edgen]), targvec[0].c - y1.dot(face[edgen]), 0);
        return [
            x1,
            y1,
            off
    ...
    allstickers() {
        const t1 = $ffeaa21825838879$var$tstart("allstickers");
        this.faces = $ffeaa21825838879$var$expandfaces(this.baseplanerot, this.faces);
        ...
        for(let i16 = 0; i16 < moveplanesets.length; i16++){
            ...
            for(let j = 0; j < q.length; j++)if (q[j].makenormal().dist(goodnormal) > $ffeaa21825838879$var$eps3) q[j] = q[j].smul(-1);
            q.sort((a, b)=>a.a - b.a);
            moveplanesets[i16] = q;
        }
        ...
        for (const q2 of this.rotations){
            if (Math.abs(Math.abs(q2.a) - 1) < $ffeaa21825838879$var$eps3) continue;
        ...
        for(let i18 = 0; i18 < moverotations.length; i18++){
            ...
            for(let j = 0; j < r.length; j++)if (goodnormal.dist(r[j].makenormal()) > $ffeaa21825838879$var$eps3) r[j] = r[j].smul(-1);
        ...
        for(let i19 = 0; i19 < moveplanesets.length; i19++){
            ...
            for (const geonormal of this.geonormals){
                ...
                if (Math.abs(d - 1) < $ffeaa21825838879$var$eps3) {
                    pos = [
                        geonormal[1],
                        geonormal[2]
                    ];
                    gtype = geonormal[2];
                } else if (Math.abs(d + 1) < $ffeaa21825838879$var$eps3) {
                    neg = [
                        geonormal[1],
                        geonormal[2]
                    ];
            ...
            if (this.addNotationMapper === "NxNxNCubeMapper" && gtype === "f") {
                this.notationMapper = new $ffeaa21825838879$var$NxNxNCubeMapper(1 + moveplanesets[i19].length);
                this.addNotationMapper = "";
            }
            if (this.addNotationMapper === "SkewbMapper" && moveplanesets[0].length === 1) {
                this.notationMapper = new $ffeaa21825838879$var$SkewbNotationMapper(this.swizzler);
                this.addNotationMapper = "";
            }
            if (this.addNotationMapper === "PyraminxOrTetraminxMapper") {
                if (moveplanesets[0].length === 2 && moveplanesets[0][0].a === 0.333333333333333 && moveplanesets[0][1].a === 1.66666666666667) {
                    this.notationMapper = new $ffeaa21825838879$var$PyraminxNotationMapper(this.swizzler);
                    this.addNotationMapper = "";
                } else {
                    this.notationMapper = new $ffeaa21825838879$var$TetraminxNotationMapper(this.swizzler);
                    this.addNotationMapper = "";
                }
            }
            if (this.addNotationMapper === "MegaminxMapper" && gtype === "f") {
                if (1 + moveplanesets[i19].length === 3) this.notationMapper = new $ffeaa21825838879$var$MegaminxScramblingNotationMapper(this.notationMapper);
                this.addNotationMapper = "";
            }
            if (this.addNotationMapper === "FTOMapper" && gtype === "f") {
                if (1 + moveplanesets[i19].length === 3) this.notationMapper = new $ffeaa21825838879$var$FTONotationMapper(this.notationMapper, this.swizzler);
                this.addNotationMapper = "";
            }
        }
        ...
        for (const facelist of facelisthash.values()){
            ...
            if (facelist.length > 1) {
                ...
                const cmall = $ffeaa21825838879$var$centermassface(cm);
    ...
    stringToBlockMove(mv) {
        ...
        return new (0, $7TbMZ.Move)(new (0, $7TbMZ.QuantumMove)(grip, hislice, loslice), amount);
    }
    parseMove(move) {
        ...
        if (!$ffeaa21825838879$var$permissivieMoveParsing && loslice === 0 && hislice === this.moveplanesets[msi].length && !fullrotation) throw new Error("! full puzzle rotations must be specified with v suffix.");
        return [
            void 0,
            msi,
            loslice,
    ...
    genperms() {
        ...
        if (this.options.orientCenters) {
            for(let k = 0; k < this.cubies.length; k++)if (this.cubies[k].length === 1) {
                ...
                if (this.basefaces[i].centermass().dist(this.facecentermass[kk]) < $ffeaa21825838879$var$eps3) {
        ...
        for(let k = 0; k < this.moveplanesets.length; k++){
            ...
            for(let i22 = 0; i22 < this.faces.length; i22++){
                ...
                for(;;){
                    ...
                    if (cm2.dist(ocm) < $ffeaa21825838879$var$eps3) break;
                ...
                if (b.length > 2 && this.options.orientCenters && (this.cubies[b[0]].length === 1 || this.duplicatedCubies[b[0]] > 1)) {
                    if (this.facecentermass[i22].dist(this.basefaces[this.getfaceindex(i22)].centermass()) < $ffeaa21825838879$var$eps3) {
                        let face1 = this.faces[this.cubies[b[0]][0]];
                        for(let ii = 0; ii < b.length; ii += 2){
                            const face0 = this.faces[this.cubies[b[ii]][0]];
                            let o = -1;
                            for(let jj = 0; jj < face1.length; jj++)if (face0.get(jj).dist(face1.get(0)) < $ffeaa21825838879$var$eps3) {
                                o = jj;
                                break;
                            }
    ...
    header(comment) {
        return comment + $ffeaa21825838879$var$copyright + "\n" + comment + "\n";
    }
    writegap() {
        ...
        for(let i = 0; i < os.moveops.length; i++){
            let movename = "M_" + $ffeaa21825838879$var$externalName(this.notationMapper, os.movenames[i]);
            let doinv = false;
    ...
    getMoveFromBits(moverange, amount, inverted, axiscmoves, setmoves, movesetorder) {
        ...
        for (const len of this.cubieords){
            perms.push($ffeaa21825838879$var$iota(len));
            oris.push($ffeaa21825838879$var$zeros(len));
        }
        for(let m = moverange[0]; m <= moverange[1]; m++){
            ...
            for(let j = 0; j < slicecmoves.length; j += 2 * movesetorder){
                ...
                if (perms[setnum] === $ffeaa21825838879$var$iota(this.cubieords[setnum])) {
        ...
        let lastId = new $ffeaa21825838879$var$PGOrbit($ffeaa21825838879$var$iota(24), $ffeaa21825838879$var$zeros(24), 1);
        for(let ii = 0; ii < this.cubiesetnames.length; ii++){
            if (setmoves && !setmoves[ii]) continue;
            if (this.orbitoris[ii] === 1 || this.options.fixedOrientation) {
                if (perms[ii] === $ffeaa21825838879$var$iota(lastId.perm.length)) {
                    if (perms[ii] !== lastId.perm) lastId = new $ffeaa21825838879$var$PGOrbit(perms[ii], oris[ii], 1);
                    moveorbits.push(lastId);
                } else moveorbits.push(new $ffeaa21825838879$var$PGOrbit(perms[ii], oris[ii], 1));
            } else {
                const no = new Array(oris[ii].length);
                for(let jj = 0; jj < perms[ii].length; jj++)no[jj] = oris[ii][perms[ii][jj]];
                moveorbits.push(new $ffeaa21825838879$var$PGOrbit(perms[ii], no, this.orbitoris[ii]));
            }
        }
        let mv = new $ffeaa21825838879$var$PGTransform(moveorbits);
    ...
    getOrbitsDef(fortwisty, includemoves = true) {
            ...
            for(let k = 0; k < this.moveplanesets.length; k++)for(let i25 = 0; i25 < this.moverotations.length; i25++){
                ...
                for(let ii = 1; ii * 2 <= this.movesetorders[i25]; ii++){
                    ...
                    for(let j = 0; j < this.moveplanenormals.length; j++){
                        if (nn.dist(this.moveplanenormals[j]) < $ffeaa21825838879$var$eps3) {
                            found = j;
                            break;
                        } else if (nn.dist(this.moveplanenormals[j].smul(-1)) < $ffeaa21825838879$var$eps3) {
                            found = j;
                            neg = true;
                            break;
                        }
        ...
        for(let i23 = 0; i23 < this.cubiesetnames.length; i23++){
            ...
            setdefs.push(new $ffeaa21825838879$var$PGOrbitDef(this.cubieords[i23], this.options.fixedOrientation ? 1 : this.orbitoris[i23]));
        }
        const solved = [];
        for(let i24 = 0; i24 < this.cubiesetnames.length; i24++){
            ...
            solved.push(new $ffeaa21825838879$var$PGOrbit(p, o, this.options.fixedOrientation ? 1 : this.orbitoris[i24]));
        }
        const movenames = [];
        const moves = [];
        if (includemoves) for(let k3 = 0; k3 < this.moveplanesets.length; k3++){
            ...
            for(let i = 0; i < moveset.length; i += 2){
                ...
                const mna = $ffeaa21825838879$var$getmovename(movesetgeo, movebits, slices);
        ...
        let r = new $ffeaa21825838879$var$PGOrbitsDef(setnames, setdefs, new $ffeaa21825838879$var$VisibleState(solved), movenames, moves);
    ...
    showcanon(disp) {
        $ffeaa21825838879$var$showcanon(this.getOrbitsDef(false), disp);
    }
    getsolved() {
        const r = [];
        for(let i = 0; i < this.baseFaceCount; i++)for(let j = 0; j < this.stickersperface; j++)r.push(i);
        return new $ffeaa21825838879$var$Perm(r);
    }
    getOrientationRotation(desiredRotation) {
        const [feature1name, [x1, y1, z1]] = desiredRotation[0];
        const direction1 = new $ffeaa21825838879$export$5edfe12bb88684c8(0, x1, -y1, z1);
        const [feature2name, [x2, y2, z2]] = desiredRotation[1];
        const direction2 = new $ffeaa21825838879$export$5edfe12bb88684c8(0, x2, -y2, z2);
        let feature1 = null;
        let feature2 = null;
    ...
    getInitial3DRotation() {
        ...
        if (!orientationDescription) orientationDescription = $ffeaa21825838879$var$defaultOrientations()[basefacecount];
    ...
    generate2dmapping(w = 800, h = 500, trim = 10, threed = false, twodshrink = 0.92) {
        ...
        geos[this.facenames[0][1]] = this.project2d(0, 0, [
            new $ffeaa21825838879$export$5edfe12bb88684c8(0, initv[0][0], initv[0][1], 0),
            new $ffeaa21825838879$export$5edfe12bb88684c8(0, initv[1][0], initv[1][1], 0)
        ]);
        const connectat = [];
        connectat[0] = 0;
        for (const neti1 of net){
            ...
            for(let j9 = 1; j9 < neti1.length; j9++){
                ...
                const epi = $ffeaa21825838879$var$findelement(bg.edgenames, mp);
                const edgename = bg.edgenames[epi][1];
                const el = $ffeaa21825838879$var$splitByFaceNames(edgename, this.facenames);
                ...
                for(let k4 = 0; k4 < otherface.length; k4++){
                    ...
                    if (mp2.dist(mp) <= $ffeaa21825838879$var$eps3) {
                        const p1 = edges2[f0][(j9 + polyn - 1) % polyn];
                        const p2 = edges2[f0][j9 % polyn];
                        connectat[gf1i] = k4;
                        geos[gf1] = this.project2d(gf1i, k4, [
                            new $ffeaa21825838879$export$5edfe12bb88684c8(0, p2[0], p2[1], 0),
                            new $ffeaa21825838879$export$5edfe12bb88684c8(0, p1[0], p1[1], 0)
                        ]);
                        break;
                    }
                }
    ...
    get3d(options) {
        ...
        for(let i = 0; i < this.basefaces.length; i++){
            ...
            faces.push({
                coords: $ffeaa21825838879$var$toFaceCoords(coords, maxdist),
                name: name
            });
        }
        for(let i30 = 0; i30 < this.faces.length; i30++){
            ...
            if (this.duplicatedFaces[i30]) {
                ...
                for(let jj = 1; jj < this.duplicatedFaces[i30]; jj++){
                    ...
                    stickers.push({
                        coords: $ffeaa21825838879$var$toFaceCoords(fcoords, maxdist),
                        color: color,
                        orbit: this.cubiesetnames[cubiesetnum],
                        ord: cubieord,
                        ori: jj,
        ...
        for(let i31 = 0; i31 < this.movesetgeos.length; i31++){
            ...
            for (const gn of this.geonormals)if (msg[0] === gn[1] && msg[1] === gn[2]) {
                grips.push({
                    coordinates: $ffeaa21825838879$var$toCoords(gn[0].rotatepoint(rot), 1),
                    quantumMove: new (0, $7TbMZ.Move)(msg[0]),
                    order: order
                });
                grips.push({
                    coordinates: $ffeaa21825838879$var$toCoords(gn[0].rotatepoint(rot).smul(-1), 1),
                    quantumMove: new (0, $7TbMZ.Move)(msg[2]),
                    order: order
                });
            }
        }
        ...
        const g = (function() {
            ...
            return function(facenum, coords) {
                let q = new $ffeaa21825838879$export$5edfe12bb88684c8(0, coords[0] * maxdist, -coords[1] * maxdist, coords[2] * maxdist);
    ...
    getGeoNormal(geoname) {
        ...
        for (const gn of this.geonormals)if (grip === gn[1]) {
            const r = $ffeaa21825838879$var$toCoords(gn[0].rotatepoint(rot), 1);
            if (Math.abs(r[0]) < $ffeaa21825838879$var$eps3 && Math.abs(r[2]) < $ffeaa21825838879$var$eps3) {
                r[0] = 0;
                r[2] = 1e-6;
            }
            return r;
...
Vertex distance ${this.vertexdistance}`;
    ...
    writeSchreierSims(tw) {
        ...
        const ss = $ffeaa21825838879$export$f17eb225ad7d7738(this.getMovesAsPerms(), tw);
        const r = as / ss;
        tw(`Ratio is ${r}`);
    }
};
var $ffeaa21825838879$export$32c5b60afe204e84 = class {
    constructor(pg, od){
        this.pg = pg;
    ...
    lookupMove(move) {
        ...
        const r = $ffeaa21825838879$var$PGOrbitsDef.transformToKTransformationData(this.orbitNames, pgmv);
        return r;
    }
};
...
//# sourceMappingURL=puzzle-geometry.7d9e3db7.js.map
